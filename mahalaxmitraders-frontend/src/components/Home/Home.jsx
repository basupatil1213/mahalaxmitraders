...
const Category = ({ category }) => {
    return (
        <div className="category-card mb-10 mx-5 h-96 flex  flex-col gap-5 items-center justify-center px-5 shadow-2xl">
...
const Home = () => {
    ...
    return (
        <>
            ...
            {/* Category Section */}
            <div className="flex flex-col gap-5 px-10 my-10 md:mt-0">
            ...
            <section>
                ...
                <div className="flex flex-col-reverse lg:flex-row justify-around items-center sm:gap-0 lg:gap-20 h-[80vh] mx-20 mb-10 md:mb-20">
                    <div className="owner-detail flex flex-col">
                        <h1 className="sm:text-9xl md:text-7xl lg:text-9xl font-primary font-bold">Arun <br />Muddennavar</h1>
                    ...
                    <div className="owner-image shadow-2xl">
                        <img src="https://media.istockphoto.com/photos/portrait-of-handsome-smiling-young-man-with-crossed-arms-picture-id1200677760?k=6&m=1200677760&s=612x612&w=0&h=IXURU5rnCRyN5h5ebeDLQcVv0lNs0ZLgE98fPioSMnQ=" alt="Owner" className="" />
                    </div>
                </div>
            </section>
        </>
